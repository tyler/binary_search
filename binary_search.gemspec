Gem::Specification.new do |s|
  ...
  s.files = ["README.textile", "VERSION.yml", "ext/extconf.rb", "ext/binary_search.c", "lib/binary_search", "lib/binary_search/native.rb", "lib/binary_search/pure.rb", "lib/binary_search.rb"]
